...
| `figures/game_evaluation.png` | `scripts/plot_game_example.py --panel b` — the same evaluation with the idiomatic rewrite, the administrator's summary and all five judges, full page | Figure 2 (arXiv v3) |
