...
DATA = Path(__file__).resolve().parent.parent / "data"; PKGD = Path(__file__).resolve().parent.parent / "data"; import os; TAG = os.environ.get("TAG", "pooled123")
SEED = 20260817
B2 = 10000
...
gpqa = {r["model"]: r for r in rdp("gpqa_selfadministered.csv")}
reps_rows = rd(f"total_rating_council_replicates_{TAG}.csv")
...
out = DATA / f"slope_band_full_{TAG}.csv"
