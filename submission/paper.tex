...
\item
  \textbf{Postulated.} The archetypal context is a semantic structure in the latent space. A context template is a literal representation of the archetypal context. The metanym sets are the particulars that, when inserted into the slots of the template, instantiate into parallel contexts, analogous metaphors.
\item
...
\item
  \textbf{Hypothesis.} The Metanym Game and GPQA run the same mechanism from opposite ends:
