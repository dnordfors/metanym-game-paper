...
\item
  \textbf{Cited.} Analogy is semantic compression. An analogy is a shared relational structure with different particulars (Gentner, 1983).
\item
  The archetypal context is a semantic structure in the latent space. A context template is a literal representation of the archetypal context. The metanym sets are the particulars that, when inserted into the slots of the template, instantiate into parallel contexts, analogous metaphors.
\item
