...
\vspace{-14pt}
\caption{The Metanym Game in one exhibit: (a) generation, one metanym set excluded to make space in the figure; (b) extract from council evaluation, two judges excluded to make space.}
