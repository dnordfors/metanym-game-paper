...
Blind spot & a misunderstanding \emph{shared} by the judges reads as truth (§5.8) & a \emph{private} misconception, held consistently, passes as a standard \\
...
\subsubsection{5.6 Measuring general intelligence without ground truth}\label{measuring-general-intelligence-without-ground-truth}
...
\subsubsection{5.7 Self-containment as a bootstrap}\label{self-containment-as-a-bootstrap}
...
\subsubsection{5.8 Scope}\label{scope}
