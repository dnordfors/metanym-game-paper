...
In the metanym game an instantiation is between two and a half and eleven times the size of its metanym set. That hints at a compression rate at scale of the same order of magnitude as has been measured for language models, about ten (Del\'{e}tang et al., 2024), and above gzip's three. Our hypothesis is that a form this compressive qualifies as a learning mechanism for a language model.
