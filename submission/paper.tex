...
\vspace{-14pt}
\caption{The Metanym Game in one exhibit: (a) generation, one metanym set excluded to make space in the figure; (b) evaluation. All five judges isolate the same clause; the disagreement that remains, 4 against 5, is about severity.}
