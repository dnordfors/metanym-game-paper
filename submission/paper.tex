...
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1094}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1719}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1875}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1719}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1875}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1719}}@{}}
...
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1429}}
...
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 12\tabcolsep) * \real{0.1111}}
...
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
...
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 4\tabcolsep) * \real{0.2727}}
...
A contest convenes the top of the field --- five seats and one contestant --- and with the weak submissions gone, the factual axis breaks: the seats' anchored \(E^{F}\) come out wrong in scale and wrong in order, swinging by up to 9.2 points depending on who the contestant is (anchored \(E^{F}=7f/f_a\) is not confined to the 1--10 rubric when the axis breaks). The \textbf{ballast} repairs this: the weakest archived submissions, added to the contest's graded set. Two suffice (\hyperref[fig-ballast]{the heatmap}).

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Each seat's anchored evaluator factual competence E\^{}\{F\} under contests with 0--3 ballast blocks (mean over the seven possible contestants), beside the reference from all 12 participants (§4.2). Council alone, the column is scrambled; from two ballast on, the contest reproduces the reference (mean \textbar\textbackslash Delta\textbar{} 0.33 over the seven contests, and the same seat is lowest in all seven). The boxed column is the protocol's configuration. Sized by re-analysis of the pinned run --- a contest is a sub-matrix of the bootstrap, so no new generation is needed. Reproduced by scripts/ballast\_\allowbreak{}sizing.py.}]{figures/ballast_heatmap.png}}
\caption{Each seat's anchored evaluator factual competence \(E^{F}\) under contests with 0--3 ballast blocks (mean over the seven possible contestants), beside the reference from all 12 participants (§4.2). Council alone, the column is scrambled; from two ballast on, the contest reproduces the reference (mean \(|\Delta|\) 0.33 over the seven contests, and the same seat is lowest in all seven). The boxed column is the protocol's configuration. Sized by re-analysis of the pinned run --- a contest is a sub-matrix of the bootstrap, so no new generation is needed. Reproduced by \protect\texttt{scripts/\allowbreak{}ballast\_\allowbreak{}sizing.py}.}
\end{figure}
...
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1364}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1364}}
...
{\relax % do not increment counter
\begin{longtable}[]{@{}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1694}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1774}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1532}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1613}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.2097}}
  >{\RaggedRight\arraybackslash\hspace{0pt}}p{(\linewidth - 10\tabcolsep) * \real{0.1290}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
{[}SLOT{]}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
