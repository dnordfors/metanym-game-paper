...
\caption{One evaluation, shown whole: the instantiation with its metanyms marked and the idiomatic rewrite, the administrator's synthesis, and two of the five judges with their justifications (all five in Appendix C). The ``Reference'' is the anchor, pinned at 7. All five judges isolate the same clause; the disagreement that remains, 4 versus 5, is about severity.}
