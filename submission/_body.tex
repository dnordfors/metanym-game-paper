...
This is the council's evaluation of gemini-2.5-flash's portfolio from the canonical run (\texttt{probe\_K\_anchor7}), the worked example of the scoring machinery described in §4.3 and §4.2. Ratings are on the anchored 1--10 scale, with the anchor portfolio of Appendix C pinned at 7 on every criterion.
...
Public-value sourcing state & \texttt{reproduce/data/external\_benchmarks.csv} \\
\end{longtable}
}
