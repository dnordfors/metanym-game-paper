> **Archived version.** This is the extended arXiv v2 of August 2026 (run 1 alone), kept whole for the detail the conference
> length dropped. The current paper, arXiv v3, is two directories up; the reproduction package it refers to is `../../reproduce/`.
> Paths below are as they were in v2.
...
submissions/        the anchor portfolio (claude-opus-4.5) and the two ballast portfolios
                    (copies of three of the run-1 portfolios in data/portfolios_run1/; every
                    generated portfolio of all three runs and every evaluation are under data/)
data/
