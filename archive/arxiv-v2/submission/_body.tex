...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1875}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1719}}@{}}
\caption{The example's metanym table --- one context template (rows are slots) filled by five metanym sets (columns are domains).}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5000}}@{}}
\caption{The twelve participants, by provider.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Provider
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{The six-axis evaluation rubric.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Axis
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
\texttt{factual\_per\_pc} & per parallel context & factual defensibility of the substituted text in its target domain \\
...
\texttt{instantiation\_distinctness} & per archetype & ``Domains far apart / metanyms not synonymous'' \\
\texttt{impressive\_length} & per archetype & template length and slot count \\
\texttt{structural\_diversity} & per portfolio & how different the five archetypes are from one another \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{The two estimators and their division of labour.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1905}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1429}}@{}}
\caption{Evaluator factual competence and generator factuality (key-free SVD).}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
...
\caption{Same-vendor robustness of the factual ordering.}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1481}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1481}}@{}}
\caption{Anchor-sweep consistency, per evaluator and axis.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Evaluator
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}@{}}
\caption{Per-criterion generator quality (G) vs evaluator reliability (E).}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
...
\textbf{cos(G,E)} & \textbf{0.91} & {[}.83,.95{]} & \textbf{0.90} & {[}.80,.93{]} & \textbf{0.89} & {[}.82,.92{]} & \textbf{0.84} & {[}.80,.87{]} & \textbf{0.87} & {[}.86,.87{]} \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3636}}@{}}
\caption{The initial council --- the five reliable evaluators.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Council member
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Factual competence {[}95\% CI{]}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Rating consistency {[}95\% CI{]}
\end{minipage} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
1 & ★ claude-opus-4.5 (anchor) & council & \textbf{7.00 {[}7.00, 7.00{]}} & 7.00 & 7.00 \\
2 & gemini-3.1-pro & council & \textbf{6.65 {[}6.53, 6.80{]}} & 7.14 & 6.16 \\
3 & claude-opus-4.0 & council & \textbf{6.04 {[}5.73, 6.39{]}} & 5.12 & 6.96 \\
4 & gemini-2.5-flash & council & \textbf{6.03 {[}5.20, 6.53{]}} & 5.93 & 6.14 \\
5 & claude-opus-4.1 & council & \textbf{5.92 {[}5.59, 6.30{]}} & 4.78 & 7.06 \\
⎯⎯ & ⎯⎯ & ⎯⎯ & ⎯⎯ & ⎯⎯ & ⎯⎯ \\
6 & claude-sonnet-4 & --- & \textbf{5.22 {[}4.92, 5.47{]}} & 3.80 & 6.64 \\
7 & gpt-4.1-mini & --- & \textbf{4.88 {[}4.15, 5.58{]}} & 4.16 & 5.60 \\
8 & gpt-4.1-2025-04-14 & --- & \textbf{4.44 {[}4.24, 4.67{]}} & 3.11 & 5.78 \\
9 & gpt-4.1-nano & --- & \textbf{3.42 {[}2.74, 3.87{]}} & 3.39 & 3.45 \\
10 & gpt-4o-2024-08-06 & --- & \textbf{3.34 {[}3.01, 3.61{]}} & 2.43 & 4.25 \\
11 & gpt-4o & --- & \textbf{2.85 {[}2.38, 3.22{]}} & 1.48 & 4.21 \\
12 & gpt-4o-mini & --- & \textbf{2.10 {[}1.75, 2.46{]}} & 1.17 & 3.02 \\
\end{longtable}
...
\caption{Competence breakdown --- the four anchored components behind each model's evaluator (\(E\)) and generator (\(G\)) scores.}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}lrr@{}}
\caption{The two instruments side by side --- the key-free total rating \(T\) (§4.7) and self-administered GPQA Diamond accuracy (voids counted as wrong), sorted by \(T\) --- the per-model values behind the family-order comparisons of §5.1.}\tabularnewline
\toprule\noalign{}
...
\caption{Total rating \(T\) across three full re-runs (run 1 = the bootstrap generation, re-analysed on the council basis; runs 2--3 the same day, two hours apart), all on the council basis of §4.7. ★ marks a council seat --- the five seats are identical across all three runs. SD is the per-model run-to-run standard deviation (mean 0.43, max 0.72, the two Gemini seats and gpt-4.1-2025-04-14 highest). Run 3's \(E^{F}\) quarter is read off a factual axis the §4.5 guard (sized in §4.6) reports as unidentified (\(\sigma_1/\sigma_2 = 1.28\)); its totals carry that caveat.}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{The eight cognitive-science constructs the metanym game demands, mapped to its two tasks.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Construct
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{The bootstrap resampling unit for each rating, with the convention each one applies.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Rating
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\PreprocessorTok{|}\NormalTok{ REVERSAL\_COST     }\PreprocessorTok{|}\NormalTok{ switching cost       }\PreprocessorTok{|}\NormalTok{ reputational cost    }\PreprocessorTok{|}
\PreprocessorTok{|}\NormalTok{ PATH              }\PreprocessorTok{|}\NormalTok{ strategy             }\PreprocessorTok{|}\NormalTok{ position             }\PreprocessorTok{|}
\PreprocessorTok{|}\NormalTok{ DECISION\_THEORY   }\PreprocessorTok{|}\NormalTok{ investment theory    }\PreprocessorTok{|}\NormalTok{ political science    }\PreprocessorTok{|}
...
This is the council's evaluation of gemini-2.5-flash's portfolio from the canonical run (\texttt{probe\_K\_anchor7}), the worked example of the scoring machinery described in §3.2 and §4.3. Ratings are on the anchored 1--10 scale, with the anchor portfolio (claude-opus-4.5's, §4.1) pinned at 7 on every criterion.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1694}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1774}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1532}}
...
\textbf{Measurement error, propagated (sensitivity).} All correlations above are computed on point estimates. Both coordinates carry known measurement distributions --- each model's \(T\) has its A.5 replicate distribution (shipped in \texttt{total\_rating\_council\_replicates.csv}), and GPQA accuracy is binomial --- so the fit can be re-derived with them propagated (\texttt{scripts/slope\_full\_bootstrap.py}; slope point estimate 8.0 GPQA points per \(T\) unit):
...
\bottomrule\noalign{}
\endlastfoot
Raw per-question responses, all models, both stages' outcome + first-pass log & \texttt{reproduce/data/gpqa\_runs/} \\
Published accuracy table & \texttt{reproduce/data/gpqa\_selfadministered.csv} \\
Scoring audit (hard-fail checks) & \texttt{reproduce/scripts/gpqa\_audit.py} \\
Official council-basis totals + CIs & \texttt{reproduce/data/total\_rating\_council.csv} \\
The §4.8 figure & \texttt{reproduce/scripts/plot\_total\_validation.py} \\
Every D.1 number (ladder, compounds, regimes, bases, per-run) & \texttt{reproduce/scripts/t\_gpqa\_ladder.py} \\
Bootstrap-basis components; per-run council-basis totals; the declined \(E^{C}_{\text{svd}}\) & \texttt{reproduce/data/total\_rating\_twelve.csv}, \texttt{total\_rating\_runs.csv}, \texttt{ec\_svd\_twelve.csv} \\
\end{longtable}
}

Every number in this appendix recomputes from the shipped data: \texttt{scripts/gpqa\_audit.py} (six hard-fail checks, including the first-pass log reconciliation) and \texttt{scripts/t\_gpqa\_ladder.py} (all of D.1, with headline assertions).
