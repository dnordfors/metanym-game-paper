...
On GPQA the reasoning channel does matter: Anthropic reports Claude Opus 4 and Claude Sonnet 4 at 74.9 and 70.0 without extended thinking and 79.6 and 75.4 with it (Anthropic, 2025), and our reasoning-off administration reads 71.2 and 72.2 for the same models (Appendix D). That is the split the hypothesis predicts: GPQA is the mechanism's use, a derivation, which reasoning helps; the game is the mechanism, a retrieval, which reasoning does not.
